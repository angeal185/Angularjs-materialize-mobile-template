        ...
        a.migrateVersion = "3.0.0",
            function() {
                var c = b.console && b.console.log && function() {
                    ...
                    d = /^[12]\./;
                c && (a && !d.test(a.fn.jquery) || c("JQMIGRATE: jQuery 3.0.0+ REQUIRED"), a.migrateWarnings && c("JQMIGRATE: Migrate plugin loaded multiple times"), c("KABOOM!" + (a.migrateMute ? "" : " with logging active")))
            }();
        var e = {};
